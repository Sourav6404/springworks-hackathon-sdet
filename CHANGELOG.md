...
### Fixed
- Success message is displayed only after the complete quote summary has been rendered successfully.
...
### Fixed
- Quote summary now displays Subtotal, Discount, GST, and Total after successful quote generation.
...
### Fixed
- POST /api/quote now validates submitted checkIds against the catalog.
- Unknown IDs return HTTP 400 Bad Request.
...
### Fixed
- Duplicate checkIds are now counted only once during subtotal calculation.
